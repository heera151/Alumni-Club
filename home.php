...
<body>
	...
	<div class="content">
		...
		<div id ="content_timeline"> 
				<form action="home.php?id=<? echo = $user_id;?>"method ="post" id ="f">
				<h2> what's your question today ?</h2>
				<input type="text " name="title" placeholder ="write here.. . . ." size ="70"  required ="required" /> <br />
				<textarea  name="content"  cols="63" rows="4" placeholder="write description" ></textarea><br />
